...
public class UsuarioControllerTest {
	...
	public void deveCadastrarUmUsuario() {
		...
		ResponseEntity<Usuario> resposta = testeRestTemplate.exchange("/usuarios/cadastrar", HttpMethod.POST, requisicao, Usuario.class);
	...
	private void deveAtualizarUmUsuario() {
		...
		ResponseEntity<Usuario> respostaAtualizacao = testeRestTemplate
